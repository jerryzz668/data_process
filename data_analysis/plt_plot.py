...
plt.title('best_fitness随iter变化曲线', fontsize=9)
plt.plot(x, y, color='green')
# plt.plot(x, y, 'o', color='green')  # 将折线图换成散点图
# plt.legend()  # 显示图例

plt.axis([0, 100, -1, 0])  # 设置范围，四个数分别对应x的起点终点和y的起点终点
plt.xlabel('iter', fontsize=9)
