...
# txt_path = 'log/demo_d_current_pop-01-24.txt'
# new_pop_txt_path = 'log/demo_d_new_population-01-24.txt'
...
def all_data2xydata(data):
    ...
    for line in data:
        ...
        line_data = np.array(float_line).reshape(42,9)  # 二维矩阵(42*8), 每个种群8=7+1   ------------------------->这里参数需要封装
